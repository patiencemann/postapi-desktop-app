...
<template>
  <footer class="mx-auto space-y-10 pb-16 h-16">
    <div class="flex flex-col items-center justify-between gap-5 px-16 border-t border-zinc-900/5 pt-5 dark:border-white/5 sm:flex-row">
      <p class="text-xs text-zinc-600 dark:text-white"> © Copyright 2023, Patienceman. All rights reserved.</p>
      <div class="flex gap-4">
        <a class="group" href="https://twitter.com/ManirabonaW"><span class="sr-only">Follow us on Twitter</span>
          <svg viewBox="0 0 20 20" aria-hidden="true" class="h-5 w-5 fill-zinc-700 transition group-hover:fill-zinc-900 dark:group-hover:fill-white dark:fill-gray-200">
        ...
        <a class="group" href="https://github.com/manirabona-programer">
