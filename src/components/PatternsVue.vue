<template>
  <div class="absolute inset-0 -z-10 mx-0 max-w-none overflow-hidden">
    ...
    >
      <div
        class="absolute inset-0 bg-gradient-to-r from-[#14B8A6] to-[#27a355] opacity-40 [mask-image:radial-gradient(farthest-side_at_top,white,transparent)] dark:from-[#36b49f]/30 dark:to-[#DBFF75]/30 dark:opacity-100"
      >
        <svg
          aria-hidden="true"
